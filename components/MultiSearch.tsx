...
const MultiSearch = ({ className }: MultiSearchProps) => {
	...
	return (
		<form method="GET" action={`${searchEngine}${encodeURIComponent(searchQuery)}`} className="w-5xl mx-auto bg-white dark:bg-slate-800 flex flex-row gap-1 p-1 rounded items-center">
