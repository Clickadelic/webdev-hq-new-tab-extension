	...
	return (
		<ThemeProvider>
			<BackgroundImage classNames="relative min-h-screen bg-neutral-100 dark:bg-neutral-900">
				...
				<UserInfoBox classNames="w-full max-w-[1180px] mt-12 mx-auto md:mt-20 xl:mt-24 mb-3 flex justify-between gap-1 p-1 pr-4" />
				<MultiSearch classNames="w-full max-w-[1180px] my-3 mx-auto bg-white/30 p-1 rounded backdrop-blur dark:bg-neutral-800/30" />
				<TabsModule classNames="w-full max-w-[1180px] mx-auto flex flex-row" />
